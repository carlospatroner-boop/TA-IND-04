...
\vspace{1.2cm}
\begin{tabular}{>{\bfseries\raggedright}p{4.6cm} p{9.6cm}}
Estudiante: & Carpio Mendoza Carlos Jose \\[3pt]
Correo: & carlospatroner@gmail.com \\[3pt]
Equipo PE-U4 / GA-SUM-05: & ACC --- Soporte Técnico ISP (Alvarez Parraga Jeremy Alexis,
 Aucatoma Celorio Jhinson Stalyn, Carpio Mendoza Carlos Jose) \\[3pt]
PFC de referencia: & ACC --- Soporte Técnico ISP (sistema de gestión de tickets de soporte
 técnico, arquitectura de microservicios) \\[3pt]
Transformación declarada como foco: & T4 --- Columna derivada compleja (clasificación de
 prioridad de atención) \\[3pt]
URL del repositorio individual: & \url{https://github.com/carlospatroner-boop/TA-IND-04} \\
\end{tabular}
...
\begin{quote}
\textbf{Repositorio de origen:}\\
\url{https://github.com/carlospatroner-boop/pe-u4-spark-Soporte-Tecnico-ISP}\\[4pt]
